...
if (!empty($_POST)) {
	...
	if (!empty($file_name)) {
		$date = $updated_at = date('Y-m-d H:s:i');
		//Luu vao database
			$sql = 'update news set title = "'.$title.'", updated_at = "'.$updated_at.'", thumbnail = "'.$file_name.'", content = "'.$content.'" where id = '.$id;
	...
	<div class="container">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h2 class="text-center">Thêm/Sửa Tin Tức</h2>
			</div>
